...
public class AccountsController : ControllerBase
{
    ...
    public async Task<ActionResult> Login([FromBody] LoginDTO modelo)
    {
        ...
        string ImagenDefault = $"https://localhost:7193/Images/NoImage.png";
        string BaseUrl = $"https://localhost:7193/Images/";
    ...
    private TokenDTO BuildToken(User user, string imgUsuario)
    {
        ...
        if (RolUsuario != null)
        {
            ...
            LogoCompa = $"https://localhost:7193/Images/NexxtplanetLLC.png";
            imgUsuario = $"https://localhost:7193/Images/NexxtplanetLLC.png";
        }
        else
        {
